"use strict";(()=>{var e={};e.id=7437,e.ids=[7437],e.modules={20399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},48156:(e,t,a)=>{a.r(t),a.d(t,{originalPathname:()=>S,patchFetch:()=>A,requestAsyncStorage:()=>x,routeModule:()=>v,serverHooks:()=>T,staticGenerationAsyncStorage:()=>k});var o={};a.r(o),a.d(o,{GET:()=>b});var i=a(69245),n=a(59863),r=a(21214),s=a(76464),l=a(85116);function c(e,t){return`

${e}: {selection}

${t}:`}let d=[{id:"inspect-website",title:"Inspect Website",prompt:`Describe me the tech stack used based on the following HTML document:
...
{browser-tab}`,creativity:"low",date:"2024-03-21",icon:"raycast-logo-neg",model:"anthropic-claude-haiku"}],icon:"raycast-logo-neg"}].map(e=>({...e,iconComponent:l.PJP[e.icon],prompts:e.prompts.map(e=>({...e,iconComponent:l.PJP[e.icon]}))})),w={name:"New",slug:"/new",prompts:f.flatMap(e=>e.prompts).filter(e=>{let t=new Date;return t.setDate(t.getDate()-14),new Date(e.date)>=t}).sort((e,t)=>new Date(t.date).getTime()-new Date(e.date).getTime()),icon:"calendar",iconComponent:l.PJP.calendar};async function b(){return s.NextResponse.json(f)}[...w.prompts.length>0?[w]:[],...f];let v=new i.AppRouteRouteModule({definition:{kind:n.x.APP_ROUTE,page:"/api/prompts/route",pathname:"/api/prompts",filename:"route",bundlePath:"app/api/prompts/route"},resolvedPagePath:"/Users/fasu/faruxue/ray-so/app/api/prompts/route.ts",nextConfigOutput:"",userland:o}),{requestAsyncStorage:x,staticGenerationAsyncStorage:k,serverHooks:T}=v,S="/api/prompts/route";function A(){return(0,r.patchFetch)({serverHooks:T,staticGenerationAsyncStorage:k})}}};var t=require("../../../webpack-runtime.js");t.C(e);var a=e=>t(t.s=e),o=t.X(0,[6673,4059,5775],()=>a(48156));module.exports=o})();